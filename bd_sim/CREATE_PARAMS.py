...
def create_params(TEMP=293.15, VISC=1e-3,
                  ...
                  MAIN_PATH="DataAnalysis_Cluster/", SUB_PATH="Results/" , N_trials = 5, Vo = 0, rho = 10**23, montecarlo_step = 2000, 
                  open_system = True, include_attraction_GCMC = True, surface_exclusion = False):
    ...
    V_o = Vo*THERMAL_ENERGY #Surface potential energy in KbT
    N_m = montecarlo_step  # Number of time steps in which a particle creation event is attempted
    ...
    # Patch vectors measured from center of mass
    ...
    #Unit patch vectors 
    PATCH_ALIGNMENT_VECTOR_1_D = PATCH_VECTOR_1 / (LA.norm(PATCH_VECTOR_1))
    PATCH_ALIGNMENT_VECTOR_2_D = PATCH_VECTOR_2 / (LA.norm(PATCH_VECTOR_2))
    ...
    # ................................random particles......................................
    PARTICLE_NUMBER = PARTNUM #Initial particle number
    SIMULATION_STEPS = SIMSTEPS #Number of simulation steps
   ...
   # NO_OF_RUNS = 1
    ...
    params = {'att_c':ATTRACTIVE_CUTOFF_D,
              ...
              'Attraction GCMC': include_attraction_GCMC,
              'Exclusion Surface': surface_exclusion
    }
